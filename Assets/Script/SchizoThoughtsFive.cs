 ...
 * Author : Chok Irene
 * Date : 03/02/2024
 * Description: This script is for set the UI to appear when the player hits the box collider for the second hidden poster in the Schizophrenia Water Scene
 */
